...
<body>
	...
	<form method="post" action="LoginServlet" >
		...
		<div class="form-group center">
			<label for="usrname"><span class="glyphicon glyphicon-user"></span>Username</label> <input type="text" id="demo1" name="name" class="form-control" 
				placeholder="Enter name">
		</div>
		<div class="form-group center">
			<label for="psw"><span class="glyphicon glyphicon-user"></span>Password</label> <input type="password" id="demo2" name="password" class="form-control"
