...
window.onload = function () {
    ...
    function praiseBox(box, el) {
        ...
        if (txt == 'Like') {
            ...
            praisesTotal.innerHTML = (newTotal == 1) ? 'I like' : 'me and' + oldTotal + 'like';
            el.innerHTML = 'cancel';
        }
        else {
            newTotal = oldTotal - 1;
            praisesTotal.setAttribute('total', newTotal);
            praisesTotal.innerHTML = (newTotal == 0) ? '' : newTotal + 'like';
            el.innerHTML = 'Like';
        }
    ...
    function reply(box, el) {
        ...
        commentBox.innerHTML =
          /*  '<img class="myhead" src="images/my.jpg" alt=""/>' +*/
                ...
                '<p class="comment-text"><span class="user">xyz:</span>' + textarea.value + '</p>' +
