...
<link rel="stylesheet" type="text/css" href="css/gear.css">
 ...
 function openDialogofProd(pid){
	// window.location="showDetailsServelt?pid="+pid;
	 ...
	 showModelessDialog ("ShowDetailsServelt?type=men&pid="+pid, window, "dialogWidth:600px; dialogHeight:400px");
 }
 </script>
</head>
<body>
 ...
 <% } %>
   <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <button type="button" class="btn btn-info btn-lg" onclick="openDialogofProd(<%=i %>)"
       
        data-toggle="modal" >Quick View</button></div>     
      </div>
    </div>
 <% }%>    
</div>
