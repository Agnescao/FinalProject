  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li>
          <c:choose><c:when test="${sessionScope.user.getName()!= 'Administrator'}"> <a href="ShowNewProductServlet">NewProduct</a></c:when>

        <c:otherwise><a href="createProduct.jsp">Upload New Product</a></c:otherwise> </c:choose> 
        <%-- <c:if test="${sessionScope.user.getName()== null}"><a href="login.jsp">NewProduct</a></c:if> --%>
       <%--  <c:if test="${sessionScope.user.getName()!= 'Administrator'}"> <a href="ShowNewProductServlet">NewProduct</a></c:if>
        <c:if test="${sessionScope.user.getName()== 'Administrator'}"> <a href="createProduct.jsp">NewProduct</a></c:if> --%>
        <li><a href="AboutUs.jsp">About us</a></li>
        <li>
        <c:choose><c:when test="${sessionScope.user.getName()!= 'Administrator'}"> <a href="ShowCommentServlet">Contact</a></c:when>
        <c:otherwise><a href="ShowAllQueriesServlet">Answer</a></c:otherwise> </c:choose>
        </li>
