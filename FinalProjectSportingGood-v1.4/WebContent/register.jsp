...
function checkifA(){
	...
	if(username=="Administrator"){
		alert("Invaild username, please change to another one!");
...
<form id="registerForm" method="post" action="RegisterServlet" name="regF">
	
	
	
	<label for="name">Name:</label>
    <input type="text" id="n" name="username" onblur="checkExist()" autofocus required ><span id="isE"></span><br>
   ...
   <input type="password" id="pwd" name="password" min="8" required  placeholder="Please enter more than 8 characters !"> <br>
    ...
    <input type="button" name="register" id="button" value="Submit" onclick="checkifA();">
