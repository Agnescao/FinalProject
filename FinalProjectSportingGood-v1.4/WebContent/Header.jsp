  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><c:choose><c:when test="${sessionScope.user.getName()!= 'Administrator'}"> <a href="ShowNewProductServlet">NewProduct</a></c:when>

        <c:otherwise><a href="createProduct.jsp">Upload New Product</a></c:otherwise> </c:choose> </li>
